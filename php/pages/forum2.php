...
if(!isset($_SESSION['id']) || empty($_SESSION['id'])){
    ...
    if (isset($_POST['message'])) {
        ...
        $sql = "INSERT INTO topic2(id, message, date, username) VALUES(0, '$message','$date', '{$_SESSION['username']}')";
        $mysqli->query($sql);
...
<form method='post' action='../php/index.php?pag=forum2'>
    <p>Message: <br>
    ...
    <p>
        <input type='submit' name='submit2' id='submit2' value='Post message' />
    </p>
    <input type='hidden' id='pag2' name='pag2' value='forum2'/>
</form>
<br>";
}
?>
